...
# spaces or shell metacharacters survive intact. The `tr -d` strips the line
# wrapping GNU base64 adds at 76 columns (macOS base64 emits a single line) —
# without it, long passphrases would silently truncate on Linux dev hosts.
