      ...
      helm.releases.homepage = {
        ...
        values = {
          controllers.homepage = {
            ...
            # app-template 5.x defaults this to false; homepage's kubernetes
            # cluster-discovery mode needs the SA token mounted (that's what
            # the homepage-discovery ClusterRole exists for).
