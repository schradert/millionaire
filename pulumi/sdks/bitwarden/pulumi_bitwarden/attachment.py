...
class AttachmentArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] file_name: File name. Required if specifying <span pulumi-lang-nodejs="`content`" pulumi-lang-dotnet="`Content`" pulumi-lang-go="`content`" pulumi-lang-python="`content`" pulumi-lang-yaml="`content`" pulumi-lang-java="`content`">`content`</span> in a resource.
        """
    ...
    def file_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        File name. Required if specifying <span pulumi-lang-nodejs="`content`" pulumi-lang-dotnet="`Content`" pulumi-lang-go="`content`" pulumi-lang-python="`content`" pulumi-lang-yaml="`content`" pulumi-lang-java="`content`">`content`</span> in a resource.
        """
...
class _AttachmentState:
    def __init__(
        ...
        *,
        ...
        size_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def size_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Size as string
        """
    ...
    @size_name.setter
    def size_name(self, value: Optional[pulumi.Input[_builtins.str]]):
