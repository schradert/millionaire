...
class GetItemLoginResult:
    ...
    def filter_folder_id(self) -> Optional[_builtins.str]:
    ...
    def filter_url(self) -> Optional[_builtins.str]:
...
def get_item_login(
    ...
    filter_folder_id: Optional[_builtins.str] = None,
    filter_organization_id: Optional[_builtins.str] = None,
    filter_url: Optional[_builtins.str] = None,
...
def get_item_login_output(
    filter_collection_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    filter_folder_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    filter_organization_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    filter_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
...
) -> pulumi.Output[GetItemLoginResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetItemLoginResult(
