...
def get_item_secure_note_output(
...
) -> pulumi.Output[GetItemSecureNoteResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetItemSecureNoteResult(
