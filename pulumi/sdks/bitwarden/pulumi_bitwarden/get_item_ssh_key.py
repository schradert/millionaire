...
def get_item_ssh_key(
    ...
    __ret__ = pulumi.runtime.invoke(
        "bitwarden:index/getItemSshKey:getItemSshKey",
        __args__,
        opts=opts,
        typ=GetItemSshKeyResult,
...
def get_item_ssh_key_output(
...
) -> pulumi.Output[GetItemSshKeyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetItemSshKeyResult(
