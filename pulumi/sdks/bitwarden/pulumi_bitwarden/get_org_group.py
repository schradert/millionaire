...
def get_org_group(
    ...
    __ret__ = pulumi.runtime.invoke(
        "bitwarden:index/getOrgGroup:getOrgGroup",
        __args__,
        opts=opts,
        typ=GetOrgGroupResult,
...
def get_org_group_output(
...
) -> pulumi.Output[GetOrgGroupResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetOrgGroupResult(
