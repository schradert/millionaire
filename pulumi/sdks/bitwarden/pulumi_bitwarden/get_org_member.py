...
def get_org_member(
    ...
    __ret__ = pulumi.runtime.invoke(
        "bitwarden:index/getOrgMember:getOrgMember",
        __args__,
        opts=opts,
        typ=GetOrgMemberResult,
...
def get_org_member_output(
...
) -> pulumi.Output[GetOrgMemberResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetOrgMemberResult(
