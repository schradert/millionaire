...
class AwaitableGetOrganizationResult(GetOrganizationResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetOrganizationResult(id=self.id, name=self.name, search=self.search)
...
def get_organization(
    ...
    __ret__ = pulumi.runtime.invoke(
        "bitwarden:index/getOrganization:getOrganization",
        __args__,
        opts=opts,
        typ=GetOrganizationResult,
...
def get_organization_output(
    ...
    return __ret__.apply(
        lambda __response__: GetOrganizationResult(
