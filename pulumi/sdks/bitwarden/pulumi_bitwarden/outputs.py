...
__all__ = [
    ...
    "GetOrgCollectionMemberGroupResult",
]
...
class ItemLoginAttachment(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ItemLoginAttachment. Access the value via the '{suggest}' property getter instead."
            )
...
class ItemLoginField(dict):
    def __init__(
        ...
        *,
        ...
        hidden: Optional[_builtins.str] = None,
        linked: Optional[_builtins.str] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def hidden(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def linked(self) -> Optional[_builtins.str]:
        """
...
class ItemLoginUri(dict):
    def __init__(
        __self__, *, value: _builtins.str, match: Optional[_builtins.str] = None
    ):
        """
...
class ItemSecureNoteAttachment(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ItemSecureNoteAttachment. Access the value via the '{suggest}' property getter instead."
            )
...
class OrgCollectionMember(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in OrgCollectionMember. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        ...
        *,
        id: _builtins.str,
        hide_passwords: Optional[_builtins.bool] = None,
        manage: Optional[_builtins.bool] = None,
        read_only: Optional[_builtins.bool] = None,
    ):
        """
        :param _builtins.str id: [Experimental] Unique Identifier (UUID) of the user or group member.
    ...
    def hide_passwords(self) -> Optional[_builtins.bool]:
        """
...
@pulumi.output_type
class OrgCollectionMemberGroup(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "hidePasswords":
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in OrgCollectionMemberGroup. Access the value via the '{suggest}' property getter instead."
            )

    def __getitem__(self, key: str) -> Any:
        OrgCollectionMemberGroup.__key_warning(key)
        return super().__getitem__(key)
...
class GetItemLoginUriResult(dict):
    def __init__(__self__, *, match: _builtins.str, value: _builtins.str):
        pulumi.set(__self__, "match", match)
        pulumi.set(__self__, "value", value)
...
@pulumi.output_type
class GetOrgCollectionMemberGroupResult(dict):
    def __init__(
        __self__,
        *,
        hide_passwords: _builtins.bool,
